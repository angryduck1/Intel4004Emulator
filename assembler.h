...
enum Opcode: uint16_t {
    ...
    INC = 0x06, // Увеличить значение в выбранном регистре на 1
    CMC = 0xF3, // Инвертировать флаг переноса
    RAL = 0xF5, // Сдвиг влево с переносом у аккумулятора
    RAR = 0xF6, // Сдвиг вправо с переносом у аккумулятора
    JCN = 0x01, // Условный переход
    XCH = 0xB,  // Обменять содержимое регистра RR с ACCUMULATOR
    IAC = 0xF2, // Увеличить значение в аккумуляторе на 1
    DAC = 0xF8, // Вычесть 1 из аккумулятора
    CMA = 0xF4, // Инвертировать биты в аккумуляторе
